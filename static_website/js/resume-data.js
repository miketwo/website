window.ResumeData = {
        ...
        "experience": [
            ...
            },
            {
                ...
                "bullets": [
                    ...
                    {
                        "description": "Led bottle prep and feeding operations in high-stress, time-critical situations.",
                        "tags": ["Leadership"]
                    },
                    {
...

            {
                ...
                "bullets": [
                    ...
                    {
                        "description": "Significantly enhanced API scope and performance, resulting in improved efficiency and user experience.",
            ...
            },
            {
                ...
                "description": "Sauce provides a cloud-based platform for the automated testing of web and mobile applications. The scope of my responsibilities covered all aspects of the continuous integration pipeline. Selected accomplishments:",
                "bullets": [
                    {
            ...
            },
            {
                ...
                "description": "Planet Labs is a multibillion-dollar Earth imaging company. As the 7th employee, I wore many hats, moving from the Spacecraft team to Manufacturing to Mission Operations. All told, I had an active role in designing, building, testing, and flying the first 113 satellites. Selected accomplishments:",
                "bullets": [
                    {
                    ...
                    },
                    {
                        ...
                        "skills": "[Python/Django on Postgres, with monitoring (Nagios, New Relic, and Elasticsearch), satellite tasking (Celery and RabbitMQ), caching (Memcache and Redis), and user interfaces (JavaScript, jQuery, D3, Highcharts, Graphite, Bootstrap, and Backbone)]",
                        "tags": ["Software", "Aerospace"]
                    },
                    {
                    ...
                    {
                        "description": "Co-led software development efforts for the Manufacturing and Production teams.",
                        "skills": "[REST API in Python/Flask, website in Python/Django, GSE in Arduino/Raspberry Pi]",
                        "tags": ["Software"]
                    },
                    {
            ...
            },
            {
                ...
                "bullets": [
                    {
                        "description": "Solely programmed the entire flight software system for USC’s first CubeSat, launched December 8, 2010 aboard SpaceX’s Falcon 9 rocket. (See publication 1.)",
                        "skills": "[C on PIC]",
                        "tags": ["Software", "Aerospace"]
                    },
                    {
                        "description": "Implemented the attitude control system for the first-ever surface-tracking CubeSat, launched in July 2012. (See publication 2.)",
                        "skills": "[C on PIC, MatrixX/Simulink on Windows]",
                        "tags": ["Software", "Aerospace"]
                    },
                    {
                        "description": "Published research on rendezvous and proximity operations using a vision-based autonomous tracking system. (See publication 3.)",
            ...
            },
            {
                ...
                "bullets": [
                    ...
                    {
                        "description": "Drove final team concurrence on regulations that had been stalled for 12 years. (See publication 4.)",
                        "tags": ["Leadership"]
                    },
                    {
        ...
        "publications": [
            ...
            },
            {
                ...
                "description": "Federal Register, Vol. 73, No. 234, December 4, 2008.",
